...
def run_scaled_dot_product_attention(
    ...
    """
    # Now directly pass the boolean mask to the function
...
def run_transformer_block(
    ...
    transform_block = TransformerBlock(d_model, num_heads, d_ff, rope=rope)
    transform_block.load_state_dict(weights, strict=False)
...
def run_transformer_lm(
    ...
    model.load_state_dict(weights, strict=False) # weights are matched by name
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    return in_features * torch.sigmoid(in_features) # seems not in document of cs336_basics
